...
You can use the [editor on GitHub](https://github.com/atosystem/midi2Tiles/edit/gh-pages/index.md) to maintain and preview the content for your website in Markdown files.
